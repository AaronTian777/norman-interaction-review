...
- Reviewing an existing interface flow
- Designing a new customer-facing UI
- Deciding which screens, content, and states a product should include
- Checking execution and evaluation gaps
- Improving feedback, mapping, signifiers, error prevention, and recovery
- Translating backend state into a user-understandable system image
...
```bash
cp -R norman-interaction-review ~/.codex/skills/
```
...
```text
Use $norman-interaction-review to review this interface flow and recommend interaction improvements.
```
